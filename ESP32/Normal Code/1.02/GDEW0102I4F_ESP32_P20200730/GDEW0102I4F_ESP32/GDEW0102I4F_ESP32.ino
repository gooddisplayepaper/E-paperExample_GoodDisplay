...
void partial_display(unsigned int x_start,unsigned int x_end,unsigned int y_start,unsigned int y_end ,void partial_old(void),void partial_new(void)); //partial display
...
void loop() {
  while(1)     
  {
    ...
    /*********partial full screen display *********/
      ...
      deep_sleep(); //EPD_sleep,Sleep instruction is necessary, please do not delete!!!
      while(1);
     }
