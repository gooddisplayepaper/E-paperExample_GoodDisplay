...
int main(void)
{
    ...
    paint_red.DrawFilledRectangle(170, 60, 210, 100, COLORED);//x1,y1,x2,y2,Diagonal point
    paint_red.DrawFilledRectangle(45, 0, 170, 20, COLORED);//x1,y1,x2,y2,Diagonal point
    paint_red.DrawFilledCircle(140, 80, 15, COLORED);//x,y,r

    /*Write strings to the buffer */
    paint_black.DrawStringAt(65, 26, "e-Paper Demo", &Font12, COLORED);//x,y
    paint_red.DrawStringAt(50, 4, "--Good display--", &Font12, UNCOLORED);//x,y
