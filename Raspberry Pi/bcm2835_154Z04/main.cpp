...
int main(void)
{
    ...
    paint_black.DrawCircle(130, 85, 30, COLORED);//x,y,r
    paint_red.DrawFilledRectangle(10, 130, 50, 180, COLORED);//x1,y1,x2,y2,Diagonal point
    paint_red.DrawFilledRectangle(0, 6, 200, 26, COLORED);//x1,y1,x2,y2,Diagonal point
    paint_red.DrawFilledCircle(130, 155, 30, COLORED);//x,y,r

    /*Write strings to the buffer */
    paint_black.DrawStringAt(30, 30, "e-Paper Demo", &Font16, COLORED);//x,y
    paint_red.DrawStringAt(10, 10, "--Good display--", &Font16, UNCOLORED);//x,y
