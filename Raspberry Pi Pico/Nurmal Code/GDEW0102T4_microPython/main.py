...
while True:
    ...
    fbuf.text('goodisplay', 0, 0, 0x00) #s, x, y[, c]
    fbuf.hline(0, 10, 152, 0x00)
    fbuf.text("Pico", 20, 16, 0x00)
     #古
    fbuf.vline(40, 40-5, 40, 0x00)#x, y, w, c
    fbuf.hline(5, 70-15, 70, 0x00)#x, y, w, c
    fbuf.rect(15+5, 92-15, 40, 40, 0x00)
