...
while True:
    ...
    fbuf.text('www.good-display.cn', 0, 0, 0x00) #s, x, y[, c]
    fbuf.hline(0, 10, 152, 0x00)
    fbuf.text("Raspberry Pico", 20, 16, 0x00)
     #古
    fbuf.vline(80, 40, 50, 0x00)#x, y, w, c
    fbuf.hline(40, 70, 80, 0x00)#x, y, w, c
    fbuf.rect(55, 92, 50, 50, 0x00)
