...
unsigned char BlackImage[12480];//Define canvas space  
...
int	main(void)
{
  ...
  ///////////////////////////GUI///////////////////////////////////////////////////////////////////////////////////
   //Data initialization settings
    ...
    //Circle
		Paint_DrawCircle(150, 150, 80, BLACK, DRAW_FILL_EMPTY, DOT_PIXEL_1X1);
    Paint_DrawCircle(250, 150,80, BLACK, DRAW_FILL_FULL, DOT_PIXEL_1X1);
    ...
    Paint_DrawString_EN(0, 0, "Good Display", &Font8, WHITE, BLACK);  //5*8
		...
		Paint_DrawString_EN(200, 130, "Good Display", &Font8, WHITE, BLACK);  //5*8
		Paint_DrawString_EN(200, 140, "Good Display", &Font12, WHITE, BLACK); //7*12
		Paint_DrawString_EN(200, 155, "Good Display", &Font16, WHITE, BLACK); //11*16
		Paint_DrawString_EN(200, 175, "Good Display", &Font20, WHITE, BLACK); //14*20
		Paint_DrawString_EN(200, 200, "Good Display", &Font24, WHITE, BLACK); //17*24
    EPD_Display(BlackImage); //display image
		EPD_sleep();//EPD_sleep,Sleep instruction is necessary, please do not delete!!!
    delay_s(2); //2s		
		/*************Number************************/
    ...
    Paint_DrawNum(240, 130, 123456789, &Font8, WHITE, BLACK);  //5*8
		Paint_DrawNum(240, 140, 123456789, &Font12, WHITE, BLACK); //7*12
		Paint_DrawNum(240, 155, 123456789, &Font16, WHITE, BLACK); //11*16
		Paint_DrawNum(240, 175, 123456789, &Font20, WHITE, BLACK); //14*20
		Paint_DrawNum(240, 200, 123456789, &Font24, WHITE, BLACK); //17*24
    EPD_Display(BlackImage); //display image
		EPD_sleep();//EPD_sleep,Sleep instruction is necessary, please do not delete!!!
    delay_s(2); //2s	 			
