...
unsigned char BlackImage[38880];//Define canvas space  
...
int	main(void)
{
  ...
  ///////////////////////////GUI///////////////////////////////////////////////////////////////////////////////////
   //Data initialization settings
    ...
    //Circle
		Paint_DrawCircle(200, 300, 150, BLACK, DRAW_FILL_EMPTY, DOT_PIXEL_1X1);
    Paint_DrawCircle(400, 300, 150, BLACK, DRAW_FILL_FULL, DOT_PIXEL_1X1);
    ...
    Paint_DrawString_EN(0, 0, "Good Display", &Font8, WHITE, BLACK);  //5*8
	  ...
	  Paint_DrawString_EN(400, 380, "Good Display", &Font8, WHITE, BLACK);  //5*8
		Paint_DrawString_EN(400, 390, "Good Display", &Font12, WHITE, BLACK); //7*12
		Paint_DrawString_EN(400, 405, "Good Display", &Font16, WHITE, BLACK); //11*16
		Paint_DrawString_EN(400, 425, "Good Display", &Font20, WHITE, BLACK); //14*20
		Paint_DrawString_EN(400, 450, "Good Display", &Font24, WHITE, BLACK); //17*24
    EPD_Display(BlackImage); //display image
		EPD_sleep();//EPD_sleep,Sleep instruction is necessary, please do not delete!!!
    delay_s(2); //2s		
		/*************Number************************/
    ...
    Paint_DrawNum(0, 0, 123456789, &Font8, WHITE, BLACK);  //5*8
	  ...
	  Paint_DrawNum(400, 380, 123456789, &Font8, WHITE, BLACK);  //5*8
		Paint_DrawNum(400, 390, 123456789, &Font12, WHITE, BLACK); //7*12
		Paint_DrawNum(400, 405, 123456789, &Font16, WHITE, BLACK); //11*16
		Paint_DrawNum(400, 425, 123456789, &Font20, WHITE, BLACK); //14*20
		Paint_DrawNum(400, 450, 123456789, &Font24, WHITE, BLACK); //17*24
    EPD_Display(BlackImage); //display image
		EPD_sleep();//EPD_sleep,Sleep instruction is necessary, please do not delete!!!
    delay_s(2); //2s	 			
