...
unsigned char BW_Image[5808];//Define canvas space  
unsigned char R_Image[5808];//Define canvas space  
//Tips//
/*
...
int	main(void)
{
  ...
  ///////////////////////////GUI///////////////////////////////////////////////////////////////////////////////////
   //Data initialization settings
    Paint_NewImage(BW_Image, EPD_WIDTH, EPD_HEIGHT, 270, WHITE); //Set screen size and display orientation
    Paint_NewImage(R_Image, EPD_WIDTH, EPD_HEIGHT, 270, WHITE); //Set screen size and display orientation
    ...
    //Circle
		Paint_DrawCircle(100, 120, 50, BLACK, DRAW_FILL_EMPTY, DOT_PIXEL_1X1);
    Paint_DrawCircle(150, 120, 50, BLACK, DRAW_FILL_FULL, DOT_PIXEL_1X1);
