...
void EPD_partial_display(u16 x_start,u16 x_end,u16 y_start,u16 y_end ,const unsigned char *new_data,unsigned char mode); //partial display
void lut(void);
void lut1(void);
...
int	main(void)
{
  ...
  driver_delay_xms(10000);
	...
	EPD_display_init(); //EPD init
	EPD_full_display(gImage_2,gImage_2,2); //Clear
	EPD_deep_sleep(); //Enter deep sleep mode,This step is a must
  driver_delay_xms(10000);
...
//////////////////////////partial display 0~9////////////////////////////////////////////	
  ...
  EPD_display_init(); //EPD init
	//Display in different positions	
  EPD_partial_display(24,72,0,192,gImage_NUM[1],0);   //654321
	 driver_delay_xms(10000);
  //EPD_partial_display(24,72,64,96,gImage_NUM[0],0);   //0     	
 for(i=0;i<7;i++)
 {
	 EPD_partial_display(24,72,64,96,gImage_NUM[i+3],1);  
 }
 driver_delay_xms(10000);
...
void EPD_partial_display(u16 x_start,u16 x_end,u16 y_start,u16 y_end ,const unsigned char *new_data,unsigned char mode) //partial display
{
	  unsigned datas,i;
		EPD_W21_WriteCMD(0X50);			//VCOM AND DATA INTERVAL SETTING			
		EPD_W21_WriteDATA(0x47);		//WBmode:VBDF 17|D7 VBDW 97 VBDB 57		WBRmode:VBDF F7 VBDW 77 VBDB 37  VBDR B7
