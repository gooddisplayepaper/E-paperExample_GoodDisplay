...
void EPD_full(void pic_display(void)); //full  display
void EPD_partial_display(u16 x,u16 y,const unsigned char *old_data,const unsigned char *new_data,unsigned int w,unsigned int l,unsigned char mode); //partial display 
void lut(void);
void lut1(void);
//partial display
...
/********partial********************/
	...
	EPD_init_4Gray(); //EPD init 4 Gray
  //Demo1
	EPD_partial_display(0,0,gImage_ta1,gImage_ta1,176,264,0); //partial display 
	EPD_partial_display(0,0,gImage_ta1,gImage_ta2,176,264,1); //partial display 
	EPD_partial_display(0,0,gImage_ta2,gImage_ta3,176,264,1); //partial display 
	EPD_partial_display(0,0,gImage_ta3,gImage_ta4,176,264,1); //partial display 
	EPD_partial_display(0,0,gImage_ta4,gImage_ta5,176,264,1); //partial display 
 DELAY_S(30);
//Clear screen (OTP)
		EPD_init(); //EPD init
		EPD_display_Clean(); //Clear screen
