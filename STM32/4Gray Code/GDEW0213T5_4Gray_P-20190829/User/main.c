...
/********partial********************/
	...
	EPD_init_4Gray(); //EPD init 4 Gray
  //Demo1
	EPD_partial_display(24,106,gImage_man1,gImage_man1,64,80,0);  //x,y,old_data,new_data,W,L,mode 	
	EPD_partial_display(24,0,gImage_gooddisplay1,gImage_gooddisplay1,24,80,0); //x,y,old_data,new_data,W,L,mode 	
	EPD_partial_display(24,0,gImage_gooddisplay1,gImage_gooddisplay1,24,80,2); //x,y,data,W,L,mode

	EPD_partial_display(24,106,gImage_man1,gImage_man2,64,80,1); //x,y,old_data,new_data,W,L,mode 	
	EPD_partial_display(0,0,gImage_gooddisplay,gImage_gooddisplay,80,24,0); //x,y,old_data,new_data,W,L,mode 	
	EPD_partial_display(0,0,gImage_gooddisplay,gImage_gooddisplay,80,24,2); //x,y,data,W,L,mode
	
	EPD_partial_display(24,106,gImage_man2,gImage_man3,64,80,1); //x,y,old_data,new_data,W,L,mode 	
	EPD_partial_display(0,80,gImage_gooddisplay,gImage_gooddisplay,80,24,0); //x,y,old_data,new_data,W,L,mode 	
	EPD_partial_display(0,80,gImage_gooddisplay,gImage_gooddisplay,80,24,2); //x,y,data,W,L,mode
	
	EPD_partial_display(24,106,gImage_man3,gImage_man4,64,80,1); //x,y,old_data,new_data,W,L,mode 	 		
	EPD_partial_display(0,132,gImage_gooddisplay,gImage_gooddisplay,80,24,0); //x,y,old_data,new_data,W,L,mode 	
	EPD_partial_display(0,132,gImage_gooddisplay,gImage_gooddisplay,80,24,2); //x,y,data,W,L,mode 
	
	EPD_partial_display(24,106,gImage_man4,gImage_man5,64,80,1);//x,y,old_data,new_data,W,L,mode 	  
	EPD_partial_display(24,188,gImage_gooddisplay2,gImage_gooddisplay2,24,80,0); //x,y,old_data,new_data,W,L,mode 	
	EPD_partial_display(24,188,gImage_gooddisplay2,gImage_gooddisplay2,24,80,2); //x,y,data,W,L,mode 
	
 //Demo2
	EPD_partial_display(24,106,gImage_man5,gImage_man5,64,80,2);//x,y,old_data,new_data,W,L,mode 	  
	EPD_partial_display(24,0,gImage_gooddisplay1,gImage_gooddisplay1,24,80,0); //x,y,old_data,new_data,W,L,mode 	
	EPD_partial_display(24,0,gImage_gooddisplay1,gImage_gooddisplay1,24,80,2); //x,y,data,W,L,mode
