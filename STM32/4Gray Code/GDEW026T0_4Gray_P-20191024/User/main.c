...
int	main(void)
{
    ...
    EPD_refresh();//EPD_refresh		
		...
		//2 gray picture(OTP)
		EPD_init(); //EPD init
		PIC_display(gImage_basemap); //basemap
    EPD_refresh();//EPD_refresh		
		EPD_sleep();//EPD_sleep`
...
/********partial********************/
	...
	EPD_init_4Gray(); //EPD init 4 Gray
  //Demo1  //123
  EPD_partial_display(16,110,gImage_num1,gImage_num1,32,32,0); //partial display 
	EPD_partial_display(16,64,gImage_num2,gImage_num2,32,32,0); //partial display 
	EPD_partial_display(16,16,gImage_num3,gImage_num3,32,32,0); //partial display 
	//456
	EPD_partial_display(56,110,gImage_num4,gImage_num4,32,32,0); //partial display 
	EPD_partial_display(56,64,gImage_num5,gImage_num5,32,32,0); //partial display 		
	EPD_partial_display(56,16,gImage_num6,gImage_num6,32,32,0); //partial display 
  //789
	EPD_partial_display(104,110,gImage_num7,gImage_num7,32,32,0); //partial display 
	EPD_partial_display(104,64,gImage_num8,gImage_num8,32,32,0); //partial display 
	EPD_partial_display(104,16,gImage_num9,gImage_num9,32,32,0); //partial display 
  ...
  u32 i,j;
	u8 temp1,temp2,temp3;
	  ...
	  //old  data
		...
		for(i=0;i<5624;i++)	               //5624*4 296*152
		{ 
			temp3=0;
      for(j=0;j<4;j++)	
			{
