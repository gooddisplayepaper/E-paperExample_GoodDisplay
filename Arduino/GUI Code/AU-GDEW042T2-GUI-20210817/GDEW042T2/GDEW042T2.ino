...
void loop()
{
  ...
  epd.SetFrameMemory(paint.GetImage(), 60, 60, paint.GetWidth(), paint.GetHeight());

  paint.Clear(UNCOLORED);
  paint.DrawFilledRectangle(0, 0, 30, 40, COLORED);
  epd.SetFrameMemory(paint.GetImage(), 20, 130, paint.GetWidth(), paint.GetHeight());

  paint.Clear(UNCOLORED);
  paint.DrawFilledCircle(32, 32, 30, COLORED);
  epd.SetFrameMemory(paint.GetImage(),60, 130, paint.GetWidth(), paint.GetHeight());
  epd.DisplayFrame();
  epd.Sleep(); 
  delay(2000);
