...
void PIC_display1(void)
{
  ...
  u8 j,temp1,temp2,temp3;
   ...
   for(i=0;i<23200;i++)       //2bit for a pixels(old is 4bit for a pixels)   
    {   
     temp1 = pgm_read_byte(&gImage_640x145_1[i]);
     ...
     for(i=23200;i<61440;i++)       //2bit for a pixels(old is 4bit for a pixels) 
     {
        for(j=0;j<2;j++)         //2bit to 4bit
